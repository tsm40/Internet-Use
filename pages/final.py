...
st.write("The dataset contained many repetitive columns, such as weight, height, and BMI. By manually removing redundant features (like height and weight, as they are encapsulated in the BMI column), we created a more streamlined and useful dataset. Additionally, we deleted rows and columns with more than 50% missing data to improve the dataset's quality.
")
